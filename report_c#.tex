...
\midrule
1 region, 1 point (baseline) & 65.0s & 1.0$\times$ \\
1 region, 3 points (3 IPs) & 28.0s & 2.3$\times$ \\
\textbf{3 regions, 9 points (9 IPs, federated)} & \textbf{12.5s} & \textbf{5.2$\times$} \\
\bottomrule
\end{tabular}
\end{table}
...
Wall-clock time is determined by the slowest region (12.5s), yielding the \textbf{5.2$\times$ speedup} over the single-point baseline.
